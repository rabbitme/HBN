...
# -----data related-----
data_root = '/media/zf/b62312d5-67f2-400e-aeea-2b6cd6624a3b3/mmdetection/data/ipiu/'  # Root path of data
# Path of train annotation file
train_ann_file = 'annotations/train.json'
train_data_prefix = '/media/zf/b62312d5-67f2-400e-aeea-2b6cd6624a3b3/ipiu/'  # Prefix of train image path
# Path of val annotation file
val_ann_file = 'annotations/val.json'
val_data_prefix = '/media/zf/b62312d5-67f2-400e-aeea-2b6cd6624a3b3/ipiu/'  # Prefix of val image path
metainfo = {
    'classes': ('car', )
}
